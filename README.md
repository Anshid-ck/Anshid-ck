...
<details>
<summary>🎯 <b>DEVELOPER PROFILE</b> <i>(Click to expand)</i></summary>
<br>
...
class Developer:
    def __init__(self):
        self.name: str = "Muhammed Anshid CK"
        self.title: str = "Full Stack Developer"
        self.location: str = "Kerala, India 🌴"
        self.passion: str = "Solving complex problems with elegant code"
    ...
    def __str__(self) -> str:
        return f"🚀 {self.name} - Turning ideas into digital reality!"
...
![Python](https://img.shields.io/badge/Python-Expert-3776AB?style=for-the-badge&logo=python&logoColor=white&labelColor=000000)
...
![Django](https://img.shields.io/badge/Django-Expert-092E20?style=for-the-badge&logo=django&logoColor=white&labelColor=000000)
